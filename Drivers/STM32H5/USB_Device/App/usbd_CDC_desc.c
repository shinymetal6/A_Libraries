...
#define USBD_PRODUCT_STRING_HS     "A Virtual ComPort"
...
extern	uint32_t	UsbDeviceId0,UsbDeviceId1;

static void Get_SerialNum(void)
{
	IntToUnicode(UsbDeviceId0, &USBD_StringSerial[2], 8);
	IntToUnicode(UsbDeviceId1, &USBD_StringSerial[18], 4);
}
