...
#define ST25R_INT_PIN            ST25R391X_INT_Pin    /*!< GPIO pin used for ST25R IRQ                   */
#define ST25R_INT_PORT           ST25R391X_INT_GPIO_Port   /*!< GPIO port used for ST25R IRQ port             */
#define IRQ_ST25R_EXTI_IRQn      ST25R391X_INT_EXTI_IRQn
...
#define platformErrorHandle()                         BSP_Error_Handler(__FILE__,__LINE__)             /*!< Global error handler or trap                */
#define platformSpiSelect()							HAL_GPIO_WritePin(ST25R391X_SS_GPIO_Port, ST25R391X_SS_Pin, GPIO_PIN_RESET);
#define platformSpiDeselect()						HAL_GPIO_WritePin(ST25R391X_SS_GPIO_Port, ST25R391X_SS_Pin, GPIO_PIN_SET);
